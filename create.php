        ...
        <article class="registration">
            ...
            <form action="create.php" method="post" class="registration-form">
                <div>
                    ...
                    <input type="number" name="price" maxlength="50" required>

                    <label for="stock_quantity">在庫数</label>
                    <input type="number" name="stock_quantity" maxlength="50" required>
                    ...
                    <select name="vendor_code" required>
                        ...
                        foreach ($vendor_codes as $vendor_code) {
                            echo "<option valu='{$vendor_code}'>{$vendor_code}</option>";
                        }

                        ?>
                    </select>
                </div> 
                <button type="submit" class="submit-btn" name="submit" value="creat">登録</button>
            </form>
        </article>
    </main>
    <footer>
